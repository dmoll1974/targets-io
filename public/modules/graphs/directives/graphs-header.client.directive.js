...
angular.module('graphs').directive('graphsTestrun', GraphsTestrunDirective);

function GraphsTestrunDirective () {

  var directive = {
    restrict: 'EA',
    templateUrl: 'modules/graphs/directives/graphs-testrun.client.view.html',
    controller: GraphsTestrunDirectiveController,
    controllerAs: 'vm'
  };
  ...
  /* @ngInject */
  function GraphsTestrunDirectiveController ($scope, $state, $stateParams, Products, Dashboards, $filter, $rootScope, Templates, Metrics, ConfirmModal, $modal, $q, $timeout) {
