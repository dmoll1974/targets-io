...
angular.module('trends').directive('trendsContent', TrendsContentDirective);

function TrendsContentDirective () {
  ...
  var directive = {
    ...
    restrict: 'EA',
    templateUrl: 'modules/trends/directives/trends-content.client.view.html',
    controller: TrendsContentDirectiveController,
    controllerAs: 'vm'
  };
  ...
  /* @ngInject */
  function TrendsContentDirectiveController ($scope, $state, $stateParams, Products, Dashboards, $filter, $rootScope, Utils, Metrics, Tags, $timeout, $mdToast, $mdDialog) {
    ...
    function setMetricShareUrl(metric) {
          ...
          vm.metricShareUrl = 'http://' + location.host + '/#!/trends/' + $stateParams.productName + '/' + $stateParams.dashboardName +  '/' + $stateParams.tag +  '?';

       /* zoom range */
          vm.metricShareUrl = vm.metricShareUrl + 'trendsZoomRange=' + Utils.trendsZoomRange.value;
