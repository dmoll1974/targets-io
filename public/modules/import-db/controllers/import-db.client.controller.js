...
angular.module('import-db').controller('ImportDbController', ['$scope', 'FileUpload','Products', 'SideMenu', '$location','$interval', function($scope, FileUpload, Products, SideMenu, $location, $interval){
