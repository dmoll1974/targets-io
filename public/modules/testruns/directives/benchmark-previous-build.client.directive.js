(function() {
    ...
    angular
        .module('testruns')
        .directive(
        'benchmarkPreviousBuild', BenchmarkPreviousBuildDirective)
    ...
    function BenchmarkPreviousBuildDirective() {
        ...
        /* @ngInject */
        function BenchmarkPreviousBuildController (
            $scope,
            $timeout,
            $filter,
            $state,
            ...
            $scope.setTab = function(newValue){
                ...
                switch (newValue) {
                    case 0:
                        $state.go('benchmarkPreviousBuildTestRun',{"productName":$stateParams.productName, "dashboardName":$stateParams.dashboardName, "testRunId" : TestRuns.selected.testRunId, "benchmarkResult" : "passed" });
                        break;
                    case 1:
                        $state.go('benchmarkPreviousBuildTestRun',{"productName":$stateParams.productName, "dashboardName":$stateParams.dashboardName, "testRunId" : TestRuns.selected.testRunId, "benchmarkResult" : "failed" });
                        break;
                }
