...
module.exports.dbExport = function (req, res) {
    ...
    //            let index = 0;
    //            return (data) => {
    //                return (!(index++) ? '"products": [' : ',') + JSON.stringify(data);
    //            };
    //        }() // invoke
    //    })
    //.on('close',  () => {
    ...
    //            let index = 0;
    //            return (data) => {
    //                return (!(index++) ? '"dashboards": [' : ',') + JSON.stringify(data);
    //            };
    //        }() // invoke
    //})
    //.on('close',  () => {
    ...
    //            let index = 0;
    //            return (data) => {
    //                return (!(index++) ? '"metrics": [' : ',') + JSON.stringify(data);
    //            };
    //        }() // invoke
    //})
    //.on('close',  () => {
    ...
    //            let index = 0;
    //            return (data) => {
    //                return (!(index++) ? '"events": [' : ',') + JSON.stringify(data);
    //            };
    //        }() // invoke
    //})
    //.on('data',  function() => {
    ...
    //            let index = 0;
    //            return (data) => {
    //                return (!(index++) ? '"testruns": [' : ',') + JSON.stringify(data);
    //            };
    //        }() // invoke
    //})
    //.on('close',  () => {
    ...
    //            let index = 0;
    //            return (data) => {
    //                return (!(index++) ? '"releases": [' : ',') + JSON.stringify(data);
    //            };
    //        }() // invoke
    //})
    //.on('close',  () => {
    ...
    //            let index = 0;
    //            return (data) => {
    //                return (!(index++) ? '"testrunSummaries": [' : ',') + JSON.stringify(data);
    //            };
    //        }() // invoke
    //})
    //.on('close',  () => {
    ...
    //            let index = 0;
    //            return (data) => {
    //                return (!(index++) ? '"templates": [' : ',') + JSON.stringify(data);
    //            };
    //        }() // invoke
    //})
    //.on('close',  () => {
    ...
    //            let index = 0;
    //            return (data) => {
    //                return (!(index++) ? '"gatlingDetails": [' : ',') + JSON.stringify(data);
    //            };
    //        }() // invoke
    //})
    //.on('close',  () => {
